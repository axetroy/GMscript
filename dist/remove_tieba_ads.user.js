...
/***/ function(module, exports, __webpack_require__) {
	...
	var main = function () {
	  function main() {
	    ...
	    this.ads = (0, _jqLite2.default)(agm);
	  }
	  ...
	  _createClass(main, [{
	    ...
	    value: function filter() {
	      this.ads.each(function (ele) {
	        ...
	        ele.style.cssText = _config2.default.debug ? '\n          border:2px solid red;\n        ' : '\n          display:none !important;\n          visibility:hidden !important;\n          width:0 !important;\n          height:0 !important;\n          overflow:hidden !important;\n        ';
	        ele.$$filtered = true;
	      });
	      return this;
	    }
	...
	var loop = (0, _$interval2.default)(function () {
	  new main(_config2.default.adRules).filter().keyword();
	}, 50);

	console.info('贴吧去广告启动...');

	(0, _jqLite2.default)(document).bind('DOMContentLoaded', function () {
